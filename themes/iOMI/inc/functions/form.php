...
function custom_post_form_submission() {
    if (
        ...
        $message .= ".email-container { max-width: 550px; margin: 0 auto; padding: 20px; border-radius: 10px; color: #313131; background-color: white; }";
        ...
        $message .= ".btn { background-color: #3f2560; color: #fff;padding: 12px 24px;text-decoration: none;text-transform: uppercase;font-weight: bold;border-radius: 6px;margin: 30px auto 15px;display: inline-block;}";
        $message .= "p.signature { margin-bottom: 0px; text-align: center; margin-top: 20px; border-top: 1px solid #e9e9e9; padding-top: 20px; }";
        $message .= "</style>";
        ...
        $message .= "<tr><td></td></tr>";
        $message .= "<tr style='border-bottom: 1px dashed #e9e9e9;'><td></td></tr>";
        $message .= "<tr><td></td></tr>";
